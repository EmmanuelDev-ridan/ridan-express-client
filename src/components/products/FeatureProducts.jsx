    ...
    return (
        <div className='w-full max-w-7xl mx-auto py-0 lg:py-2 px-1'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-1 lg:gap-2'>
                {products.map((p, i) => (
                    <div key={i} className='bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 group overflow-hidden relative flex flex-col'>
                        <Link to={`/product/details/${p.slug}`} className='relative flex-1'>
                            {p.discount && (
                                <div className='absolute left-2 top-2 bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-bold z-10'>
                                    {p.discount}% OFF
                                </div>
                            )}
                        ...
                        <div className='absolute top-3 right-3 block lg:hidden flex flex-col gap-2'>
                            <button
                                onClick={(e) => add_card(p._id, e)}
                        ...
                        <div className="py-3 px-2 text-gray-700">
                            ...
                            <div className="flex py-1 font-semibold">
                                ...
                                <button
                                    ...
                                    className='flex items-center ml-[4rem] block lg:hidden justify-center hover:text-red-500 transition-all'
                                    aria-label="Add to wishlist"
                                >
                                    <AiFillHeart className='w-6 h-6 border border-orange-500 rounded-full p-1' />
                                </button>
                            </div>
